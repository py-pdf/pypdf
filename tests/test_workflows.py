...
@pytest.mark.parametrize(
    ...
    [
        ...
        (True, "file://"+os.path.join(RESOURCE_ROOT, "test Orient.pdf"),[0]),           #TODO: preparation of text orientation validation
        (True, "file://"+os.path.join(RESOURCE_ROOT, "fdocuments.in_sweet-fundamentals-of-crystallography.pdf"),[0,1,34,35,36,118,119,120,121]),
    ],
)
